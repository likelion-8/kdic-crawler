...
def log_run(question: str, resp: ChatResponse, sub_plans: list, latency_ms: int,
            trace_id=None, served_from: Optional[str] = None) -> None:
    ...
    log_rag_run(
        ...
        # served_from='cache' 는 검색을 안 탄 건이라 sub_plans 가 비어 있다 — 관측이 통째로
        # NULL 이면 가드레일 차단·Gate EXIT 와 구분되지 않아 AD-005 가 이유를 못 말한다.
