...
export const MOCK_ACTIVITY_EVENTS: ActivityEvent[] = [
  ...
  { id: 'ev_004', occurred_at: '2026-08-02T18:31:20+09:00', actor: 'editor@demo', actor_role: 'EDITOR', action: '프롬프트 게시', target: 'prompt v12', result: '거부됨', reason: 'Smoke 27/30', request_id: 'req_a4', ip: '10.0.3.21', triage: 'NONE' },
