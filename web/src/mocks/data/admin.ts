...
export const MOCK_ACTIVITY_EVENTS: ActivityEvent[] = [
  ...
  { id: 'ev_004', occurred_at: '2026-08-02T18:31:20+09:00', actor: 'editor@demo', actor_role: 'EDITOR', action: '프롬프트 게시', target: 'prompt v12', result: '거부됨', reason: 'Smoke 27/30', request_id: 'req_a4', ip: '10.0.3.21', triage: 'IN_REVIEW' },
  { id: 'ev_005', occurred_at: '2026-08-01T11:31:47+09:00', actor: 'ops@demo', actor_role: 'OPERATOR', action: '선택 재수집 실행', target: 'sender_docs, receiver_docs', result: '실패', reason: '서식 링크 변경 확인', request_id: 'req_a5', ip: '10.0.3.33', triage: 'IN_REVIEW' },
