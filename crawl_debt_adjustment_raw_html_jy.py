...
출력:
    data/raw/html/debt_adjustment/DEBT-001.html
    ...
    data/raw/html/debt_adjustment/DEBT-008.html

    data/raw/responses/debt_adjustment/DEBT-001.json
    ...
...
RAW_HTML_DIR = PROJECT_ROOT / "data" / "raw" / "html" / "debt_adjustment"
RESPONSE_DIR = PROJECT_ROOT / "data" / "raw" / "responses" / "debt_adjustment"
MANIFEST_PATH = (
    PROJECT_ROOT
    / "data"
    / "manifests"
