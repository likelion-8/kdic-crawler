...
| 문서 | 무엇이 있나 | 언제 기준 |
|---|---|---|
| [`CODEBASE.md`](CODEBASE.md) | P1 데이터 파이프라인(`src/crawler/`) 온보딩. 단계별 파일 표, 데이터 산출물, **저장소에서 유일하게 실행 커맨드가 있는 문서** | 2026-08-05 · Supabase 전환 반영됨. ⚠️ P2 RAG 코어·`api/`·`web/`은 다루지 않는다 |
